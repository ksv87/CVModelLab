...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String? lookup(MessageKey key, MessageParams p) {
    return switch (key) {
      ...
      MessageKey.remoteApiKeyRequired => 'This server requires an API key.',
      ...
      MessageKey.remoteProject => 'Remote project',
      MessageKey.themeTooltip => 'Theme',
      MessageKey.themeSystem => 'System',
      MessageKey.themeLight => 'Light',
      MessageKey.themeDark => 'Dark',
      MessageKey.navProject => 'Project',
      MessageKey.navImages => 'Images',
      MessageKey.navMetrics => 'Metrics',
      MessageKey.navCompare => 'Compare',
      MessageKey.navReports => 'Reports',
      MessageKey.navMore => 'More',
      MessageKey.mobileOverlayOptions => 'Overlay options',
      MessageKey.mobileNextImage => 'Next image',
      MessageKey.mobilePrevImage => 'Previous image',
      MessageKey.mobileNextError => 'Next error',
      MessageKey.mobilePrevError => 'Previous error',
      MessageKey.mobileOpenFilters => 'Open filters',
      MessageKey.mobileApplyFilters => 'Apply filters',
      MessageKey.mobileResetFilters => 'Reset filters',
      MessageKey.mobileFilters => 'Filters',
      MessageKey.mobileFullMatrix => 'Full matrix',
      MessageKey.mobileTopConfusedPairs => 'Top confused pairs',
      MessageKey.mobileMissedPairs => 'Missed pairs',
      MessageKey.mobileBackgroundFpPairs => 'Background false positives',
      MessageKey.mobileLargeExportWarning =>
        'Large exports may take time on mobile browsers.',
      MessageKey.mobileCompactLayout => 'Compact layout',
      MessageKey.mobileDetails => 'Details',
      MessageKey.mobileShowDetails => 'Show details',
      MessageKey.mobileBackToList => 'Back to list',
      MessageKey.mobileModelView => 'Model view',
      MessageKey.mobileDiffView => 'Diff view',
      MessageKey.mobileBaseModel => 'Base',
      MessageKey.mobileCandidateModel => 'Candidate',
      MessageKey.mobileFitToScreen => 'Fit to screen',
      MessageKey.mobileRemoteClientMode => 'Remote client mode',
      MessageKey.mobileRemoteClientExplanation =>
        'Mobile apps work as remote clients. Start CV Model Lab Server and connect to its URL.',
      MessageKey.mobileLocalUnavailable =>
        'Local projects are not available on mobile.',
      MessageKey.mobileOpenRecentRemoteProject => 'Open Recent Remote Project',
      MessageKey.mobileRememberApiKeyOnDevice =>
        'Remember API key on this device',
      MessageKey.mobileForgetSavedApiKey => 'Forget saved API key',
      MessageKey.mobileDisconnectServer => 'Disconnect server',
      MessageKey.mobileExportDesktopPwaOnly =>
        'This export is available on Desktop/PWA.',
      MessageKey.mobileExportLimited =>
        'Mobile support is limited in this version.',
      MessageKey.mobileServerUnreachable => 'Server unreachable',
      MessageKey.mobileNetworkError => 'Network error',
      ...
      MessageKey.reportExecutiveSummary => 'Executive Summary',
      MessageKey.reportAppendix => 'Appendix: Top Error Examples',
      MessageKey.reportImagesByStatus => 'Images by Status',
