...
// Source of truth: tools/ap_evaluator/ap_eval.py
// Regenerate with: scripts/gen_ap_eval_script.dart (see ap_eval_script_test.dart guard).
//
// Embedded so the sidecar ships inside the app binary and needs no on-disk
// packaging on any desktop platform.
const String apEvalScriptSource = r'''
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.8"
